...
<html lang="ja">
    <head>
        ...
        <style>
            * {
            ...
            .content-block:focus-within .remove-block {
                opacity: 1;
            }
            .block-image-input {
                width: 100%;
    ...
    <body>
        <main class="shell">
            <section class="panel">
                ...
                @php
                    ...
                    $articleBlocks = $article?->blocks ?? collect();
                    $blocks = collect($oldBlocks ?? $articleBlocks)->values();
                ...
                >
                    ...
                    <section class="block-editor" aria-label="記事本文ブロック">
                        <div class="block-editor-title">
                            <div>
                                <h2>記事本文</h2>
                                <span class="hint">NOTEのように、テキストと画像を上から順番に並べられます。画像にはキャプションも付けられます。</span>
                            </div>
                        ...
                        <div id="article-blocks" class="article-canvas">
        ...
        <script>
            const blocksRoot = document.getElementById('article-blocks');
